...
public class TrieTest {
    ...
    /**
     * Test of lisääSanat method, of class Trie.
     */
    @Test
    public void testLisääSanat() {
        System.out.println("lis\u00e4\u00e4Sanat");
        String[] sanat = null;
        Trie instance = new Trie();
        instance.lisääSanat(sanat);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }

    /**
     * Test of lisääSana method, of class Trie.
     */
    @Test
    public void testLisääSana() {
        System.out.println("lis\u00e4\u00e4Sana");
        String sana = "";
        int rivi = 0;
        Trie instance = new Trie();
        instance.lisääSana(sana, rivi);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of etsiSolmu method, of class Trie.
     */
    @Test
    public void testEtsiSolmu() {
        System.out.println("etsiSolmu");
        String sana = "";
        Trie instance = new Trie();
        TrieSolmu expResult = null;
        TrieSolmu result = instance.etsiSolmu(sana);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
